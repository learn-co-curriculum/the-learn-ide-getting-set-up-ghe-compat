Nice! You’re all connected with GitHub. Now, it’s time to start using that “Learn IDE” – short for Integrated Development Environment – that we mentioned in the last lesson. Follow the instructions below to download the IDE.
...
4. Don’t worry about opening the IDE yet, we will walk you through opening it and getting started in the next lesson. If you do open it, you'll see a temporary directory - that's fine! Check out the image below of what that looks like. We’ll walk you through how to get started with a lab in the IDE in the next lesson.
